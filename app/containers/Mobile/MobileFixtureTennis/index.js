...
const MobileFixtureTennis = ({ type, fixtureData, isLoading }) => {
                ...
                sortedInplayFalseMatches.map((_items, index) => {
                  ...
                  return (
                    <>
                      ...
                      _items?.runners?.[1]?.backPrice1 ||
                      _items?.runners?.[1]?.layPrice1 ||
                      (_items?.runners?.[2]?.backPrice1 ?? null) ||
                      (_items?.runners?.[2]?.layPrice1 ?? null) ? (
                        <div
                          key={index}
                          className="flex items-center justify-between"
                        >
...
MobileFixtureTennis.propTypes = {
  type: PropTypes.string.isRequired,
  isLoading: PropTypes.bool.isRequired,
  fixtureData: PropTypes.array.isRequired,
};

export default MobileFixtureTennis;
